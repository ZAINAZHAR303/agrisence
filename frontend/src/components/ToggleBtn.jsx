...
const Switch = ({theme , themefunc}) => {
  return (
    <StyledWrapper>
      <label className="switch">
        <input type="checkbox" value={theme} onClick={themefunc}/>
